...
- Every release in the release plan carries `dir`, the package directory relative to the workspace root, and `name`, `oldVersion`, and `newVersion` are `null` for a package without them.
